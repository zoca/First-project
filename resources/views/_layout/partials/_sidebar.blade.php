    ...
    <div class="slimscroll-menu" id="remove-scroll">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="@route('dynamicforms.create')" aria-expanded="true"><i class="fi-layers"></i> <span>Dynamic Forms</span></a>                   
                </li>
                <li>
                    <a href="javascript: void(0);" aria-expanded="true"><i class="fi-share"></i> <span>Categories</span> <span class="menu-arrow"></span></a>
                    <ul class="nav-second-level nav" aria-expanded="true">
                        <li><a href="@route('categories.list')">All categories</a></li>
                        <li><a href="@route('categories.create')">New category</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript: void(0);" aria-expanded="true"><i class="fi-share"></i> <span>Products</span> <span class="menu-arrow"></span></a>
                    <ul class="nav-second-level nav" aria-expanded="true">
                ...
                <li>
                    <a href="javascript: void(0);" aria-expanded="true"><i class="fi-share"></i> <span>Posts</span> <span class="menu-arrow"></span></a>
                    <ul class="nav-second-level nav" aria-expanded="true">
                        <li><a href="@route('posts.list')">All posts</a></li>
                        <li><a href="@route('posts.create')">New post</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript: void(0);" aria-expanded="true"><i class="fi-share"></i> <span>Tags</span> <span class="menu-arrow"></span></a>
                    <ul class="nav-second-level nav" aria-expanded="true">
                        <li><a href="@route('tags.list')">All tags</a></li>
