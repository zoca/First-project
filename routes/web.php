...
Route::middleware(['auth'])->group(function () {
    ...
    Route::name('posts.')->prefix('/posts/')->group(function () {
        ...
        Route::post('new-order', $c . 'neworder')->name('neworder');
        ...
        Route::post('{entity}/comment/{comment}/deleteComment', $c . 'deleteComment')->name('deleteComment');
    });
    ...
    Route::name('formtypes.')->prefix('/formtypes/')->group(function () {
        $c = 'FormTypesController@';
        Route::get('', $c . 'all')->name('list');
        Route::post('datatable', $c . 'datatable')->name('datatable');
        Route::get('create', $c . 'create')->name('create');
        Route::post('create', $c . 'store');
    ...
    Route::name('dynamicforms.')->prefix('/dynamicforms/')->group(function () {
        $c = 'DynamicFormsController@';
        Route::get('', $c . 'all')->name('list');
        Route::post('datatable', $c . 'datatable')->name('datatable');
        Route::get('create', $c . 'create')->name('create');
        Route::post('create', $c . 'store');
